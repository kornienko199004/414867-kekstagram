...
(function () {
  ...
  window.initializeScale = function (uploadFileElement, uploadFileElementLabel, scaleElement, adjustScale) {
    ...
    uploadFileElementLabel.addEventListener('drop', setDefaultScale);
  };
})();
